...
#include "jibo_msgs/msg/detail/jibo_remote__rosidl_typesupport_fastrtps_c.h"
...
using _JiboRemote__ros_msg_type = jibo_msgs__msg__JiboRemote;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JiboRemote__ros_msg_type * ros_message = static_cast<const _JiboRemote__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: do_enter_rosbridge_skill
  {
    cdr << (ros_message->do_enter_rosbridge_skill ? true : false);
  }

  // Field name: do_exit_rosbridge_skill
  {
  ...
  void * untyped_ros_message)
{
  ...
  _JiboRemote__ros_msg_type * ros_message = static_cast<_JiboRemote__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_jibo_msgs__msg__JiboRemote(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JiboRemote__ros_msg_type * ros_message = static_cast<const _JiboRemote__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _JiboRemote__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jibo_msgs__msg__JiboRemote(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_jibo_msgs
size_t max_serialized_size_jibo_msgs__msg__JiboRemote(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jibo_msgs__msg__JiboRemote;
    is_plain =
      (
...
static size_t _JiboRemote__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jibo_msgs__msg__JiboRemote(
...
static message_type_support_callbacks_t __callbacks_JiboRemote = {
  "jibo_msgs::msg",
  "JiboRemote",
...
static rosidl_message_type_support_t _JiboRemote__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JiboRemote,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jibo_msgs, msg, JiboRemote)() {
  return &_JiboRemote__type_support;
}
