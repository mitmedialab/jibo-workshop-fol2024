...
#include "jibo_msgs/msg/detail/jibo_vec3__rosidl_typesupport_fastrtps_c.h"
...
using _JiboVec3__ros_msg_type = jibo_msgs__msg__JiboVec3;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JiboVec3__ros_msg_type * ros_message = static_cast<const _JiboVec3__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr << ros_message->x;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _JiboVec3__ros_msg_type * ros_message = static_cast<_JiboVec3__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _JiboVec3__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jibo_msgs__msg__JiboVec3(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jibo_msgs__msg__JiboVec3;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _JiboVec3__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jibo_msgs__msg__JiboVec3(
...
static message_type_support_callbacks_t __callbacks_JiboVec3 = {
  "jibo_msgs::msg",
  "JiboVec3",
...
static rosidl_message_type_support_t _JiboVec3__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JiboVec3,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jibo_msgs, msg, JiboVec3)() {
  return &_JiboVec3__type_support;
}
