...
static const _JiboAsrCommand_type_support_symbol_names_t _JiboAsrCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jibo_msgs, msg, JiboAsrCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jibo_msgs, msg, JiboAsrCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, jibo_msgs, msg, JiboAsrCommand)() {
  return &::jibo_msgs::msg::rosidl_typesupport_c::JiboAsrCommand_message_type_support_handle;
}
